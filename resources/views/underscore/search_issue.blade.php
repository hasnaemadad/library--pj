<div class="" style="background:#63D3DD; color:#fff"><center>Book Details</center></div>
...
%>
<div class="" style="background:#63D3DD; color:#fff"><center>Student Details</center></div>
<dl class="dl-horizontal">
    <dt>Student ID</dt>
